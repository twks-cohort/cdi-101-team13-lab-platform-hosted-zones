...
provider "aws" {
  alias  = "subdomain_nonprod_us_east_2_cdicohorts_thirteen"
  region = "us-east-2"
  assume_role {
...
module "subdomain_nonprod_us_east_2_cdicohorts_thirteen" {
  source  = "terraform-aws-modules/route53/aws//modules/zones"
  version = "2.0.0"
  create  = true

  providers = {
    aws = aws.subdomain_nonprod_us_east_2_cdicohorts_thirteen
  }

  zones = {
    "nonprod-us-east-2.${local.domain_cdicohorts_thirteen}" = {
      tags = {
        cluster = "nonprod"
      }
    }
...
module "subdomain_zone_delegation_nonprod_us_east_2_cdicohorts_thirteen" {
  ...
  records = [
    {
      ...
      records         = lookup(module.subdomain_nonprod_us_east_2_cdicohorts_thirteen.route53_zone_name_servers,"nonprod-us-east-2.${local.domain_cdicohorts_thirteen}")
    }
  ]

  depends_on = [module.subdomain_nonprod_us_east_2_cdicohorts_thirteen]
}